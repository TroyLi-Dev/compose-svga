...
open class SVGAImageView @JvmOverloads constructor(
    ...
    private var forceLowFPS = false
    private val LOW_FPS_NUM = 12
    ...
    private fun play(range: SVGARange?, reverse: Boolean) {
        ...
        animator.duration =
            ((mEndFrame - mStartFrame + 1) * (1000 / fps) / generateScale()).toLong()
