        ...
        public ShapeEntity decode(ProtoReader reader) throws IOException {
            ...
            for (int tag; (tag = reader.nextTag()) != -1; ) {
                switch (tag) {
                    ...
                    case 10:
                        builder.styles(ShapeStyle.ADAPTER.decode(reader));
                        break;
                    case 11:
