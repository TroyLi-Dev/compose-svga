...
class SVGAActivitiesCache {
    ...
    private var mCache: LruCache<String, SVGAVideoEntity> = object : LruCache<String, SVGAVideoEntity>(DEFAULT_MAX_SIZE) {
        override fun sizeOf(key: String, value: SVGAVideoEntity): Int {
            return getImageSize(value)
        }

        override fun entryRemoved(evicted: Boolean, key: String, oldValue: SVGAVideoEntity, newValue: SVGAVideoEntity?) {
