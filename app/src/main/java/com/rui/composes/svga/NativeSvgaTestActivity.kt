...
class NativeSvgaTestActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainContent.addView(RowLayout(this).apply {
            ...
            addView(TextView(context).apply {
                text = "Native 压力测试"; textSize = 18f; setTypeface(
                null,
        ...
        mainContent.addView(TextView(this).apply {
            text = "资源单项预览"; setPadding(
            dp2px(
                context,
                16f
            ), dp2px(context, 8f), dp2px(context, 16f), dp2px(context, 8f)
        )
        })
        ...
        mainContent.addView(TextView(this).apply {
            text = "300 个极限测试网格 (原生)"; setPadding(
            dp2px(context, 16f),
            dp2px(context, 8f),
            dp2px(context, 16f),
            dp2px(context, 8f)
    ...
    private fun createDashboard(): View {
        ...
        val fpsTxt =
            TextView(this).apply { text = "FPS: 0"; setTextColor(Color.GREEN); textSize = 16f }
        val cpuTxt =
            TextView(this).apply { text = "CPU: 0%"; setTextColor(Color.WHITE); textSize = 14f }
        ...
        val memTxt =
            TextView(this).apply { text = "MEM: 0/0"; setTextColor(Color.WHITE); textSize = 12f }
        ...
        container.addView(RowLayout(this).apply {
            ...
            addView(TextView(context).apply {
                text = "干扰"; setTextColor(Color.WHITE); textSize = 12f
            })
        ...
        lifecycleScope.launch {
            ...
            fpsCallback = object : android.view.Choreographer.FrameCallback {
                override fun doFrame(frameTimeNanos: Long) {
                    ...
                    if (fpsCallback != null) android.view.Choreographer.getInstance()
            ...
            while (isActive) {
                ...
                memTxt.text =
                    "MEM: ${(runtime.totalMemory() - runtime.freeMemory()) / 1048576}MB / ${runtime.maxMemory() / 1048576}MB"
    ...
    private fun preloadResources() {
        ...
        lifecycleScope.launch {
            iconUrls.forEach { url ->
                val request =
                    ImageRequest.Builder(this@NativeSvgaTestActivity).data(url).allowHardware(false)
                        .build()
    ...
    class PreviewAdapter(val urls: List<String>) : RecyclerView.Adapter<PreviewAdapter.VH>() {
        ...
        override fun onCreateViewHolder(p: ViewGroup, t: Int): VH {
            ...
            return VH(SVGAImageView(p.context).apply {
    ...
    class GridAdapter(val urls: List<String>) : RecyclerView.Adapter<GridAdapter.VH>() {
        ...
        override fun onCreateViewHolder(p: ViewGroup, t: Int): VH {
            ...
            return VH(SVGAImageView(p.context).apply {
                layoutParams = ViewGroup.LayoutParams(size, size); scaleType =
    ...
    class RowLayout(context: Context) : LinearLayout(context) { init {
        orientation = HORIZONTAL; gravity = Gravity.CENTER_VERTICAL
    }
    }

    class NativeFlyingData(val start: Offset, val url: String) {
...
fun View.postFrameCallback(callback: android.view.Choreographer.FrameCallback) =
